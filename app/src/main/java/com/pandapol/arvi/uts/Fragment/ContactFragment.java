...
/**
 * Created by 10116282 - Arvi Ramadhan - AKB7, 19-20 Mei 2019
 */
    ...
    public void intentemail() {
        ...
        try {
             likeIng.setType("plain/text")
                    ...
                    .putExtra(Intent.EXTRA_SUBJECT, "PandapolApp's email test")
                    .putExtra(Intent.EXTRA_TEXT, "Hello. this is a message sent from PandapolApp's :-)");
