...
/**
 * Created by 10116282 - Arvi Ramadhan, 17 Mei 2019
 */
...
public class WalkthroughActivity extends AppCompatActivity {
    ...
    private String description_array[] = {
            "Selamat Datang di PandapolApp's !",
            "PandapolApp's adalah aplikasi yang berisi tentang profil Arvi Ramadhan," +
                    " dan dibuat untuk memenuhi nilai UTS kelas AKB-7 a.k.a IF-7",
            "Tap Mulai untuk menggunakan aplikasi !",
    };
